	    ...
	    <table class="simple" cellspacing="0" cellpadding="0">
	            ...
	            <tbody>
	                ...
	                <tr>
                        ...
                        <td><a href="
                            <?php echo html_escape(uri('tei-display/config/edit'));?>
                            ?id=<?php echo $entry['id']; ?>" class="edit">Edit</a>
                        </td>
	                </tr>
	                <?php endforeach; ?>
	            </tbody>
...
<?php } 
    ...
    echo '<p>No TEI files identified in system.  <a href="' .
        html_escape(uri('items/add')) . '">Add an Item.</a></p>'; 
}
